...
{
    sfTexture *t_head = sfTexture_createFromFile("assets/characters/player_male/male_head.png", 0);
    sfTexture *t_body = sfTexture_createFromFile("assets/characters/player_male/male_body.png", 0);
    sfTexture *t_arm = sfTexture_createFromFile("assets/characters/player_male/male_arm.png", 0);
    sfTexture *t_leg = sfTexture_createFromFile("assets/characters/player_male/male_leg.png", 0);
