...
animator_t *init_pnj_animator()
{
    ...
    sfTexture *t_arm = sfTexture_createFromFile("assets/characters/alien/alien_arm.png", 0);
    sfTexture *t_leg = sfTexture_createFromFile("assets/characters/alien/alien_leg.png", 0);
